...
export const DYNAMIC_VARIABLES = [
  ...
  { key: "payment_label", label: "Libellé de l'échéance (rappel)" },
  { key: "payment_amount", label: "Montant de l'échéance (rappel)" },
  { key: "payment_due_date", label: "Date d'échéance (rappel)" },
