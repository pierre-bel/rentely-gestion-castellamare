  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-full sm:max-w-md overflow-y-auto">
        <SheetHeader>
          <SheetTitle>Filtrer les versements</SheetTitle>
          <SheetDescription>
          ...
          <div className="space-y-3">
            ...
            <RadioGroup value={pendingTransactionTypeFilter} onValueChange={setPendingTransactionTypeFilter}>
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="type-all" className="font-normal cursor-pointer">Toutes les transactions</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="booking_payout" id="type-earning" />
                <Label htmlFor="type-earning" className="font-normal cursor-pointer">Revenus réguliers</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="debt_collection" id="type-debt" />
                <Label htmlFor="type-debt" className="font-normal cursor-pointer">Recouvrements</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="refund_debt" id="type-refund" />
                <Label htmlFor="type-refund" className="font-normal cursor-pointer">Remboursements</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="cancelled" id="type-cancelled" />
                <Label htmlFor="type-cancelled" className="font-normal cursor-pointer">Annulations</Label>
              </div>
            </RadioGroup>
          </div>
          ...
          <div className="space-y-3">
            ...
            <RadioGroup value={pendingStatusFilter} onValueChange={setPendingStatusFilter}>
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="status-processing" className="font-normal cursor-pointer">En cours</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="completed" id="status-completed" />
                <Label htmlFor="status-completed" className="font-normal cursor-pointer">Terminé</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="settled" id="status-settled" />
                <Label htmlFor="status-settled" className="font-normal cursor-pointer">Réglé</Label>
              </div>
            </RadioGroup>
          </div>
