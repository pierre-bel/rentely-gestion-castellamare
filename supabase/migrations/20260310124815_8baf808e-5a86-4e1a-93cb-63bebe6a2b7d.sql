...
-- Add visibility settings to cleaning_staff
ALTER TABLE public.cleaning_staff 
  ADD COLUMN portal_past_months integer NOT NULL DEFAULT 1,
  ADD COLUMN portal_future_months integer NOT NULL DEFAULT 3;

-- Update the RPC to also return visibility limits
